...
def get_three_entrys_model(maxlen, max_features,embed_size,embedding_matrix,n_classes):
    ...
    x1 = Bidirectional(CuDNNLSTM(256, return_sequences=True))(embedding_1)
    ...
    x1 = Bidirectional(CuDNNLSTM(128, return_sequences=True))(embedding_1)
    x2 = Bidirectional(CuDNNLSTM(128, return_sequences=True))(x1)
    ...
    x_concat = concatenate([avg_pool4,avg_pool5,max_pool6])
    ...
    x = concatenate([max_pool1,max_pool2,max_pool3,avg_pool4,x_concat_2,features_dense])
